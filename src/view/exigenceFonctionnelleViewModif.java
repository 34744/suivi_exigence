	 ...
	 */
		...
		public exigenceFonctionnelleViewModif(int idFocntionnalite, int idSousFonctionnalite, int codeSousFonctionnalite,String nomExigenceFonctionnelle, String nomSousFonctionnalite, Boolean liste) {
			...
			panel.add(btnDetail);
				...
				btnDetail = new JButton("<<Liste des crit�res de succ�s");
				btnDetail.setHorizontalAlignment(SwingConstants.RIGHT);
				btnDetail.setForeground(SystemColor.activeCaption);
				btnDetail.setFocusPainted(false);
				btnDetail.setBorderPainted(false);
		...
		private class MyButtonListener implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(source == btnAnnuler){
					...
					System.out.println("�cran exigence idFonct"+exigenceFonctionnelleActive.getFkFonct()+nomSFAnnule);
				...
				if(source==btnDetail){
					if(btnDetail.getText()=="<<Liste des crit�res de succ�s"){
						liste=true;
					}
					else{
						liste=false;	
		...
		private void remplirPriorite(String nomExigenceFonctionnelle){
			...
			vectPriorite = controllerDBExigenceFonctionnelle.getPriorite();
			comboBoxPriorite.addItem("--S�lectionnez importance--");
