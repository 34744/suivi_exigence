...
public class Parametres extends JPanel{
	 ...
	 * Create the panel.
	 */
	public Parametres(boolean ajout, int ongletSelectionne) {
		...
		pane.addTab("Application", ongletAppli);
		...
		pane.addTab("Direction générale", ongletDG);
	...
	public class maDirection implements ItemListener{
