...
public class gestionFenetreExigenceFonctionnelle {
	...
	public static void modifExigenceFonctionnelle (int idSousFonctionnalite, int codeExigenceFonctionnelle, String nomExigenceFonctionnelle, Boolean liste){
		view.exigenceFonctionnelleViewModif exigenceFonctionnelleModif = new view.exigenceFonctionnelleViewModif(idSousFonctionnalite, codeExigenceFonctionnelle, nomExigenceFonctionnelle, liste);
